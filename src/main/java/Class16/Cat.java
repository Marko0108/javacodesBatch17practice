package Class16;
/*
Create Cat class define 6 fields create multiple constructors to give flexibility to the end user.
PrintInfo method as well to print all the details of a cat.
 */
public class Cat {
