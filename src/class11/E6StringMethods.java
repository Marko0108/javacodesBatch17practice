...
public class E6StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println(str.replaceAll("[0-9]", ""));
        System.out.println(str.replaceAll("[A-z]", ""));
        System.out.println(str.replaceAll("[&-;]", ""));  //ASCII
        System.out.println(str.replaceAll("[A-C]", ""));
        System.out.println(str.replaceAll("[A-Z0-9]", ""));
        System.out.println(str.replaceAll("[A-Z0-58-9a-j]", ""));
        System.out.println(str.replaceAll("[ks2S-]", ""));
        System.out.println(str.replaceAll("\\d", ""));//remove all digits   www.regexr.com
        System.out.println(str.replaceAll("\\s", ""));
        System.out.println(str.replaceAll("[^A-Z]", ""));  //remove everything but not A-Z
