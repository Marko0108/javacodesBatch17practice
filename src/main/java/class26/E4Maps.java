...
public class E4Maps {
    public static void main(String[] args) {
        ...
        makeup.put("EyeLiner",25.5);
        //makeup.forEach((k,v)-> System.out.println(k+" "+v));                  // x key y value  lambda  both keys and values
        //makeup.forEach((k,v)-> System.out.println(k));                          // only keys
        //makeup.forEach((k,v)-> System.out.println(v));                        //only values
        //makeup.forEach((k,v)-> System.out.println(v));              //whenever you need more than one parameter you need to put parentheses
