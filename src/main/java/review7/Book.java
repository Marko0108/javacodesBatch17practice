...
public class Book {
    ...
    static int totalBooks;   //static variable is variable defined inside the class but outside any method,
                             // constructor of block of code - static variable is defined with static keyword
